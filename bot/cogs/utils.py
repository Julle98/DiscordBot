...
KOMENTOJEN_ROOLIT = {
    ...
    "tehtävät": "24G",
    "kauppa": "24G",
    "liity": "Musan kuuntelija",
    "kuuntelutiedot": "Musan kuuntelija",
    "biisijono": "Musan kuuntelija",
    "skip": "Musan kuuntelija",
    "jonolista": "Musan kuuntelija",
    "loppu": "Musan kuuntelija",
}

KOMENTOJEN_KUVAUKSET = {
    "aika": "Näyttää nykyisen ajan",
    "moikka": "Tervehtii käyttäjää",
    "esittely": "Näyttää botin esittelyn",
    "nofal": "Nofal-komento",
    "kutsumalinkki": "Antaa kutsulinkin bottiin",
    "ruokailuvuorot": "Näyttää ruokailuvuorot",
    "ruoka": "Kertoo päivän ruoan",
    "sano": "Botti sanoo jotain puolestasi",
    "mielipide": "Antaa satunnaisen mielipiteen",
    "laskin": "Laskee annetun laskutoimituksen",
    "ajastin": "Käynnistää ajastimen",
    "kulppi": "Kertoo Kulpin ajan",
    "seuraava_lomapäiva": "Näyttää seuraavan lomapäivän",
    "meme": "Lähettää satunnaisen meemin",
    "help": "Avaa dropdownin ongelman ilmoittamiseen",
    ...
    "ilmoitus": "Lähettää ilmoituksen kanavalle",
    "clear": "Poistaa viestejä",
    "lukitse": "Lukitsee kanavan",
    ...
    "unban": "Poistaa bannin",
    "huolto": "Kytkee botin huoltotilan päälle/pois",
    "set_role": "Antaa käyttäjälle roolin",
    "remove_role": "Poistaa käyttäjältä roolin",
    "liity": "Liittyy äänikanavaan",
    "verifiointi": "Verifioi uudet jäsenet",
    "vitsi": "Kertoo satunnaisen vitsin",
    "reagoi": "Reagoi viestiin, joka sisältää tietyn tekstin",
    "tehtävät": "Näytä ja suorita päivittäisiä tai viikottaisia tehtäviä",
    "kauppa": "Näytä kaupan tuotteet tai osta tuote",
    "liity": "Valitse botin puhekanavalle liittyminen",
    "soita": "Soittaa kappaleen YouTubesta",
    "kuuntelutiedot": "Näyttää kappaleen tiedot",
    "biisijono": "Näyttää toistojonon",
    "skip": "Hyppää seuraavaan kappaleeseen",
    "jonolista": "Näyttää koko jonon",
    "loppu": "Lopettaa musiikin ja tyhjentää jonon"
}
